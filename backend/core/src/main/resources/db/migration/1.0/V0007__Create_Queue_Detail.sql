...
queueNumber VARCHAR(5), creationTime TIMESTAMP, startTime TIMESTAMP, endTime TIMESTAMP, minEstimatedTime VARCHAR(60),
idVisitor BIGINT NOT NULL, idEvent BIGINT NOT NULL, CONSTRAINT PK_QueueDetail PRIMARY KEY(id),
