package com.devonfw.application.jtqbackend.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the jtqbackend application.
 */
