package com.devonfw.application.jtqbackend.eventmanagement.service.impl.rest;
...
import com.devonfw.application.jtqbackend.eventmanagement.service.api.rest.EventmanagementRestService;
...
public class EventmanagementRestServiceImpl implements EventmanagementRestService {
  ...
  @Override
  public EventCto getEventCto(long id) {

    return this.eventmanagement.findEventCto(id);
  }

  @Override
  public Page<EventCto> findEventCtos(EventSearchCriteriaTo searchCriteriaTo) {

    return this.eventmanagement.findEventCtos(searchCriteriaTo);
  }
