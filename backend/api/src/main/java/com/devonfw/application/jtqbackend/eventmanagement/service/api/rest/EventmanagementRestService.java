...
public interface EventmanagementRestService {
  ...
  /**
   * Delegates to {@link Eventmanagement#findEventCto}.
   *
   * @param id the ID of the {@link EventCto}
   * @return the {@link EventCto}
   */
  @GET
  @Path("/event/cto/{id}/")
  public EventCto getEventCto(@PathParam("id") long id);

  /**
   * Delegates to {@link Eventmanagement#findEventCtos}.
   *
   * @param searchCriteriaTo the pagination and search criteria to be used for finding events.
   * @return the {@link Page list} of matching {@link EventCto}s.
   */
  @Path("/event/cto/search")
  @POST
