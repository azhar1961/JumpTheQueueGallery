...
let QueueDetailCrudService = class QueueDetailCrudService extends crud_typeorm_1.TypeOrmCrudService {
    constructor(repo) {
        super(repo);
    }
};
QueueDetailCrudService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(queue_detail_entity_1.QueueDetail)),
